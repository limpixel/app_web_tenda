...
<body>
        ...
        <div class="container mx-auto flex justify-between items-center p-4">
            <div class="flex items-center gap-8">
                ...
                <nav class="space-x-6 hidden md:block">
                    ...
                    <a href="{{route('frontend.contact')}}" class="text-gray-700 hover:text-blue-500">Contact</a>
                </nav>
            </div>
            <div class="space-x-4 hidden md:block">
                @guest
                    ...
                    <a href="{{ route('register') }}" class="bg-blue-500 text-white py-2 px-4 rounded ml-4">Register</a>
                    @endif

                    @else
                    <a href="{{route('dashboard.home')}}" class="text-gray-700 hover:text-blue-500">{{ Auth::user()->name }}</a>
                @endguest
            </div>
            <!-- Toggle Button -->
    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-screen-xl space-y-8 px-4 pt-16 pb-0 sm:px-6  lg:px-8">
            <div class="flex  justify-between ">
                ...
                <div class="grid grid-cols-1 gap-32 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4 text-sm">
                            ...
                            <li>
                                <a href="#" class="text-gray-700 transition hover:opacity-75"> Product </a>
                            </li>

                            <li>
                                <a href="#" class="text-gray-700 transition hover:opacity-75"> Testimony </a>
                            </li>

                            <li>
                                <a href="#" class="text-gray-700 transition hover:opacity-75"> Blos </a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4 text-sm">
                            ...
                            <li>
                                <a href="#" class="text-gray-700 transition hover:opacity-75"> Terms Of Service </a>
                            </li>
            ...
            <div class="border-t-2 py-5 text-xs text-center text-gray-500">&copy; 2022. Company Name. All rights
                reserved.</div>
        </div>
    </footer>
    ...
    <script type="module">
        ...
        function initializeKeenSlider() {
            // Create the KeenSlider instance with initial options
            const keenSlider = new KeenSlider('#keen-slider', {
                loop: true,
                slides: {
                    origin: 'center',
                    perView: 1, // Default for mobile
                    spacing: 16, // Default spacing for mobile
                },
            });

            // Function to update KeenSlider based on screen size
            function updateSliderSettings() {
                if (window.matchMedia('(min-width: 1280px)').matches) {
                    // For large screens (1280px and up)
                    keenSlider.update({
                        slides: {
                            origin: 'auto',
                            perView: 4,
                    ...
                    // For medium screens (1024px - 1279px)
                    keenSlider.update({
                        slides: {
                            origin: 'auto',
                            perView: 2,
                    ...
                    // For small screens (640px - 1023px)
                    keenSlider.update({
                        slides: {
                            origin: 'center',
                            perView: 2,
                    ...
                    // For extra small screens (less than 640px)
                    keenSlider.update({
                        slides: {
                            origin: 'center',
                            perView: 1,
            ...
            // Listen for resize events to update the slider settings
            window.addEventListener('resize', updateSliderSettings);

            // Initial check to apply the correct settings on page load
