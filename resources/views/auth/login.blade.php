                ...
                <form method="POST" action="{{route('login')}}" class="mt-8 grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="email" id="email" name="email"
                            class="mt-1 w-full  py-2 px-4 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm @error('email') text-red-500 font-bold @enderror " />
                    ...
                    <div class="col-span-6 ">
                        ...
                        <input type="password" id="Password" name="password"
                            class="mt-1 w-full px-4 py-2 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
                    </div>
